...
const PURCHASE_AMOUNT_EXIST_ERROR = '구입 금액이 입력되지 않았습니다.';
...
const PURCHASE_AMOUNT_FIRST_DIGIT_ERROR = '구입 금액 맨 앞자리에 0이 없어야 합니다.';
const PURCHASE_AMOUNT_WHITE_SPACE_ERROR = '구입 금액에 공백이 없어야 합니다.';
...
const PURCHASE_AMOUNT_ERROR_MESSAGE = Object.freeze({
  ...
  firstDigitZero: `${PURCHASE_AMOUNT_ERROR} ${PURCHASE_AMOUNT_FIRST_DIGIT_ERROR}`,
  whiteSpace: `${PURCHASE_AMOUNT_ERROR} ${PURCHASE_AMOUNT_WHITE_SPACE_ERROR}`,
});
